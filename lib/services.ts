...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    image: "/alcove-unit-1.png",
    imageAlt: "Professional door hanging service by CN Carpentry in Bath",
    gallery: [
      { src: "/alcove-unit-1.png", alt: "Quality carpentry finish", caption: "Precision and attention to detail on every job" },
      { src: "/alcove-shelving.png", alt: "Professional carpentry work", caption: "Clean lines and a professional finish" },
      { src: "/carpentry-work-1.png", alt: "Carpentry craftsmanship", caption: "Craftsmanship you can trust" },
    ],
    category: "general",
  ...
  },
  {
    ...
    image: "/van-conversion.png",
    imageAlt: "Custom garden decking by CN Carpentry in Bath",
    gallery: [
      { src: "/van-conversion.png", alt: "Outdoor carpentry project", caption: "Quality timber work built to last" },
      { src: "/alcove-shelving.png", alt: "Precision woodwork", caption: "The same precision we bring to indoor and outdoor projects" },
      { src: "/alcove-unit-2.png", alt: "Craftsmanship detail", caption: "Attention to detail in every build" },
    ],
    category: "general",
