...
export const services: ServiceData[] = [
  {
    ...
    image: "/alcove-unit-1.png",
    imageAlt: "Bespoke fitted wardrobe by CN Carpentry in Bath",
    gallery: [
      { src: "/alcove-unit-1.png", alt: "Built-in fitted wardrobe with drawers", caption: "Fitted unit with integrated drawers and shelving" },
      { src: "/alcove-unit-2.png", alt: "Custom wardrobe interior layout", caption: "Custom interior designed to maximise storage" },
      { src: "/alcove-shelving.png", alt: "Fitted shelving and storage", caption: "Open shelving with cupboard storage below" },
    ],
    category: "bespoke",
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/alcove-unit-1.png", alt: "Custom TV unit with drawers", caption: "Bespoke TV unit with integrated drawer storage" },
      { src: "/alcove-shelving.png", alt: "Built-in shelving display", caption: "Open shelving for display and media equipment" },
    ],
    category: "bespoke",
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/carpentry-work-1.png", alt: "Built-in storage unit", caption: "Integrated storage with clean lines" },
    ],
    category: "bespoke",
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/alcove-unit-2.png", alt: "Custom van storage solutions", caption: "Quality woodwork and attention to detail" },
      { src: "/carpentry-work-1.png", alt: "Bespoke built-in units", caption: "The same craftsmanship we bring to every project" },
    ],
    category: "bespoke",
  ...
  },
  {
    ...
    gallery: [
      { src: "/door-hanging-1.jpg", alt: "Clean white interior door fitted in a modern room", caption: "Interior door fitted with even gaps and smooth operation" },
      { src: "/door-hanging-2.jpg", alt: "Row of white interior doors in a hallway", caption: "Multiple doors hung with consistent finish throughout" },
      { src: "/door-hanging-3.jpg", alt: "Modern interior door installation", caption: "Professional door hanging with quality hardware" },
    ],
    category: "general",
  ...
  },
  {
    ...
    image: "/decking-1.jpg",
    imageAlt: "Wooden garden decking installed by CN Carpentry in Bath",
    gallery: [
      { src: "/decking-1.jpg", alt: "Wooden garden decking area with outdoor seating", caption: "Custom timber decking built to last" },
      { src: "/decking-2.jpg", alt: "Outdoor deck and patio area with garden views", caption: "Decking designed to complement your outdoor space" },
      { src: "/decking-3.jpg", alt: "Modern house with quality deck and garden", caption: "Quality outdoor carpentry for any garden" },
    ],
    category: "general",
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/carpentry-work-1.png", alt: "Room with quality flooring", caption: "Professional fitting throughout" },
      { src: "/alcove-unit-1.png", alt: "Flooring and fitted furniture", caption: "Flooring combined with bespoke fitted units" },
    ],
    category: "general",
  ...
  },
  {
    ...
    gallery: [
      { src: "/carpentry-work-1.png", alt: "Skirting and trim detail", caption: "Clean mitre joints and a professional finish" },
      { src: "/alcove-shelving.png", alt: "Skirting around fitted units", caption: "Matching skirting integrated with fitted furniture" },
      { src: "/alcove-unit-2.png", alt: "Trim and moulding work", caption: "Precision trim work throughout" },
    ],
    category: "general",
